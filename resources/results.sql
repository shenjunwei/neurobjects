...
--
-- Host: localhost
-- Generation Time: Sep 28, 2011 at 02:54 PM
...
CREATE TABLE IF NOT EXISTS `results` (
  ...
  `surrogate` enum('uniform','poisson','col_swap','neuron_swap','matrix_swap','col_swap_d','poisson_d','uniform_d','spike_jitter','mean_d') DEFAULT NULL,
