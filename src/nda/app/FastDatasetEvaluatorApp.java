...
import nda.analysis.evaluation.FastDatasetEvaluator;
 ...
 */
public class FastDatasetEvaluatorApp {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < filepaths.length-1; i += 2) {
            ...
            try {
                ...
                FastDatasetEvaluator evaluator = new FastDatasetEvaluator(gen_setup, eva_setup);
                evaluator.setVerbose(cml.hasOption('v'));

                List<EvaluationResult> results = evaluator.run();
